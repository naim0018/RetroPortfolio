...
const projects = [
  {
    title: "BestBuy4uBD",
    description: "A modern e-commerce platform built with React and Next.js, featuring secure user authentication, product management, and integrated Bkash payment system.",
    tech: ["React", "Next.js", "Node.js", "Bkash"],
  ...
  },
  {
    ...
    description: "A specialized e-commerce platform for handcrafted textile products. Features include user authentication and a seamless shopping experience.",
  ...
  {
    title: "Component UI",
    description: "A collection of reusable UI components built with React and TailwindCSS, designed for efficiency in web development projects.",
      ...
      <main className="container mx-auto px-6 pt-32 pb-20 max-w-7xl">
        <header className="mb-16 space-y-4">
          ...
          <p className="text-foreground/50 max-w-2xl font-medium">
            A curated list of tactical web deployments and technical research projects. 
            All sessions are encrypted and stored in the decentralized neural network.
          </p>
        </header>
          ...
          {projects.map((project, i) => (
            ...
            >
              ...
              <div className="flex justify-between items-start">
                ...
                <span className="text-[10px] font-mono opacity-30">ID_00{i+1}</span>
              </div>
              ...
              {/* Corner Brackets */}
              <div className="absolute top-0 left-0 w-2 h-2 border-t border-l" style={{ borderColor: `${project.color}66` }} />
              <div className="absolute top-0 right-0 w-2 h-2 border-t border-r" style={{ borderColor: `${project.color}66` }} />
              <div className="absolute bottom-0 left-0 w-2 h-2 border-b border-l" style={{ borderColor: `${project.color}66` }} />
              <div className="absolute bottom-0 right-0 w-2 h-2 border-b border-r" style={{ borderColor: `${project.color}66` }} />
            </motion.div>
          ))}
        </div>
      </main>
