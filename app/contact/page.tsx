      ...
      <main className="container mx-auto px-6 pt-24 pb-12 max-w-7xl h-screen overflow-hidden flex flex-col justify-center">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <p className="text-foreground/50 max-w-2xl font-medium">
            Ready to bring your ideas to life? Drop a message into the encrypted
            uplink and let&apos;s create something amazing together.
          </p>
        </header>
            <div className="space-y-4">
                ...
                {socialLinks.map((link, i) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <span
                        className="block text-[10px] font-mono opacity-40 uppercase tracking-[0.2em]"
          ...
          <div className="space-y-4">
            <div className="border border-white/10 p-8 bg-white/2 relative group backdrop-blur-sm">
              ...
              <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                <div className="space-y-2">
                  <label className="text-[10px] font-mono text-accent-pink/60 uppercase tracking-widest">
                    Identify_Yourself
                  </label>
                  <input
                    type="text"
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-mono text-accent-orange/60 uppercase tracking-widest">
                    Return_Address
                  </label>
                  <input
                    type="email"
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-mono text-accent-blue/60 uppercase tracking-widest">
                    Broadcast_Data
                  </label>
                  <textarea
                    rows={4}
            ...
            <div className="p-8 border-2 border-dashed border-white/10 font-mono text-[11px] opacity-40 space-y-2">
              <div className="flex justify-between">
                ...
                <span className="text-accent-green animate-pulse">
